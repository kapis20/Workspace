...
graphviz_path = r'D:\python\Graphviz\bin\dot.exe'
os.environ["PATH"] += os.pathsep + os.path.dirname(graphviz_path)
# Create a sample graph
# G = nx.Graph()
# G.add_edges_from([(1, 2), (1, 3), (2, 4), (3, 4)])

# # Define the root for layout (if needed)
# root = None  # or specify a root node if your graph has one
# pos = graphviz_layout(G, prog="dot", root=root, args="-Gdpi=300")
